		...
		<div class="row">
			<div class="col-md-6">
				<ul>
                    ...
                    <form id="form2" method="post" action="<?php echo erLhcoreClassDesign::baseurl('departament/departaments')?>"> 
                        <input hidden="true" name="inpu" value="2"/>
                    </form>

                    <form id="form3" method="post" action="<?php echo erLhcoreClassDesign::baseurl('departament/departaments')?>">
                        <input hidden="true" value="inpu" />
                    </form>
